...
export default function Home() {
  return (
    <>
      ...
      <section className="feature-project section dark-section"><div className="site-container feature-project-grid"><div className="feature-image"><ResponsiveImage src="/images/projects/whole-home-family-room-renovation.png" alt="Completed family room addition with a brick fireplace, vaulted ceiling, exposed beams, and broad windows" sizes="(max-width: 760px) calc(100vw - 30px), 55vw" /><span aria-label="Reserved image caption area" /></div><div className="feature-copy"><span className="eyebrow light">Featured work</span><h2>New family room as part of a whole-home renovation.</h2><p>A bright, comfortable family room addition brings more space for everyday living while tying naturally into the character and flow of the existing home.</p><dl><div><dt>Project</dt><dd>Whole-home renovation</dd></div><div><dt>Details</dt><dd>New family room addition</dd></div><div><dt>Focus</dt><dd>Connection, comfort, finish detail</dd></div></dl><a href="/projects/hutter-whole-house-remodel-addition" className="text-link light">View the complete project <ArrowRight size={18} /></a></div></div></section>
