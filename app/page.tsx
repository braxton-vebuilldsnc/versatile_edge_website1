...
import { processSteps, serviceAreaPages, serviceAreas, services } from "@/lib/site-data";
  ...
  return (
    <>
      ...
      <section className="home-hero">
        <ResponsiveImage src="/images/projects/hutter-kitchen-04.webp" alt="Completed Versatile Edge Hutter kitchen renovation with white cabinetry and an open dining connection" sizes="100vw" priority />
      ...
      <section className="section realistic-budget"><div className="site-container realistic-budget-grid"><div><span className="eyebrow light">A clearer investment from the start</span><h2>We treat a renovation as an upgrade to your home.</h2></div><div><p className="lead">A proposal can look less expensive when it is built around builder-grade fixtures, tile, cabinets, or other low allowances. But when those placeholders do not reflect what you actually want in your home, the cost rises as selections are made.</p><p>Versatile Edge builds allowances around realistic upgrade-level selections and the scope needed to install them well. That gives you a clearer expectation of the final investment from the beginning—rather than a low initial number that grows once you choose the products you want.</p><p>In the end, a low allowance does not make the finished renovation less expensive. It can simply delay the honest conversation about cost.</p></div></div></section>
      ...
      <section className="feature-project section dark-section"><div className="site-container feature-project-grid"><div className="feature-image feature-image-pair"><div className="feature-image-main"><ResponsiveImage src="/images/projects/mid-century-bath-cary-shower.webp" alt="Completed Cary mid-century bathroom with green vertical tile, black fixtures, and a walk-in shower" sizes="(max-width: 760px) 62vw, 34vw" /><span>Actual Versatile Edge project</span></div><ResponsiveImage src="/images/projects/mid-century-bath-cary-shelving.webp" alt="Open wood shelving in the completed Cary mid-century bathroom" sizes="(max-width: 760px) 38vw, 21vw" /></div><div className="feature-copy"><span className="eyebrow light">Featured work</span><h2>A Cary bathroom with room for the everyday.</h2><p>Green vertical tile, warm walnut, patterned wallcovering, and open shelving turn this compact bathroom into a considered space with practical storage built into the experience.</p><dl><div><dt>Project</dt><dd>Mid-century bathroom renovation</dd></div><div><dt>Details</dt><dd>Walk-in shower, walnut vanity, open shelving</dd></div><div><dt>Focus</dt><dd>Daily function, storage, finish detail</dd></div></dl><a href="/projects/mid-century-bath-renovation-cary" className="text-link light">View the complete project <ArrowRight size={18} /></a></div></div></section>
