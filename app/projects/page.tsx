...
export const metadata: Metadata = { title: "Projects", description: "See actual kitchen, bathroom, deck, and addition work completed by Versatile Edge in Wake County and the Triangle." };
