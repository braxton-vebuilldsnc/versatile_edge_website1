...
export const servicePageContent: Record<string, {
  ...
  "kitchen-renovations": {
    ...
    valueParagraphs: ["A successful kitchen renovation is more than a collection of cabinets, countertops, and finishes. Before the finished materials arrive, we may need to coordinate demolition, framing, plumbing, electrical work, ventilation, inspections, drywall, flooring, and the precise field measurements that allow cabinets and countertops to fit as intended.", "Those decisions affect one another. Moving an appliance can change the electrical plan; a new range hood may affect duct routing; a larger island may influence clearances, lighting, storage, and the way the household moves through the room. We work through those relationships early, so the visible choices are supported by a practical construction plan.", "As a complimentary part of working with Versatile Edge, our team can meet you at cabinet, countertop, tile, appliance, and other showrooms to help with selections. It is no-cost, practical guidance to compare options, understand how they work together, and keep finishes aligned with the layout, budget, and overall character of your home.", "From the first walkthrough through final details, Versatile Edge manages the moving parts behind the finished kitchen. The result is a room that is not simply beautiful in a rendering or product sample, but thoughtfully planned and built for daily life."]
  },
